package amal.souheil.savemytrip.tripbook;
...
import amal.souheil.savemytrip.utils.StorageUtils;
...
public class TripBookActivity extends BaseActivity {
    ...
    private static final String AUTHORITY="amal.souheil.savemytrip.fileprovider";
