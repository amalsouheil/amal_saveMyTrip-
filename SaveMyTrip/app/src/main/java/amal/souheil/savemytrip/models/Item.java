package amal.souheil.savemytrip.models;
...
public class Item {
    ...
    public Item(String text, int category, long userID, String path) {
        this.text = text;
        this.category = category;
        this.userId = userID;
        this.isSelected = false;
    ...
    public static Item fromContentValues(ContentValues values) {
        ...
        if (values.containsKey("picturePath")) item.setPicturePath(values.getAsString("picturePath"));
        return item;
    }
}